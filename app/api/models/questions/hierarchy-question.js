...
export default class HierarchyQuestion extends QuestionWithAnswers {
    ...
    setValue(value) {
        ...
        if (changed) {
            this._updateHierarchy().then(() => this._onChange({ value: this._diffPrimitives(oldValue, this.value) }));
        }
    }
    ...
    *_getNodeGenerator() {
    ...
    async _updateHierarchy() {
        ...
        const rawChildNodes = await this._hierarchyService
            .getHierarchySubLevel(this._id, this._value)
            .catch((error) => {
